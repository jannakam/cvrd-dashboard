      ...
      <div className="px-4 py-8">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground">
            Try a new plan. You can always change back if you don&apos;t love
            it.
          </p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          {plans.map((plan) => (
            ...
            >
              <Card
                className={`h-full relative transition-all duration-300 mt-4 overflow-hidden flex flex-col ${
              ...
              >
                {plan.isCurrentPlan && (
                  <div className="bg-primary text-primary-foreground text-sm px-4 py-1 z-20 whitespace-nowrap">
                    Current plan
                  </div>
                )}
