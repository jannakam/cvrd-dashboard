...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      {/* Navigation Bar */}
      <nav className="fixed top-0 w-full z-40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 border-b">
        <div className="container flex h-16 items-center justify-between">
          <div className="flex items-center gap-6">
            {/* Netflix Logo Placeholder */}
            <div className="h-8 w-24 bg-red-600 rounded flex items-center justify-center text-white font-bold">
              NETFLIX
            </div>
      ...
      <div className="relative h-[56.25vw] min-h-[400px] max-h-[800px] w-full">
        <div className="absolute inset-0 bg-zinc-900 flex items-end">
          <div className="container pb-20">
            <div className="max-w-[600px] space-y-4">
              <h1 className="text-4xl md:text-6xl font-bold">Featured Title</h1>
              <p className="text-lg md:text-xl">
                Watch the latest movies and TV shows on Netflix. Stream now or
